...
//you can put multiple addresses separeted by a come
const addressNames = {
  tz1SzHsckFKTQYzwMWZUEj2W1YbrAHRFmNaw: "furiadesignerone"
...
const fetchAllQuery = {
    ...
    query FetchMyObjkts($addresses: [String!], $include_tags: [String!]) {
      ...
      hic_et_nunc_token(
        where: {
          ...
          token_holders: {
            quantity: { _gt: 0 }
            holder_id: { _neq: "tz1SzHsckFKTQYzwMWZUEj2W1YbrAHRFmNaw" }
          }
        }
        order_by: { id: desc }
      ) {
  ...
  variables: {
    ...
    include_tags: ["poetry", "animation", "sketch4processing", "pixelart", "machine learning","generative art"],
  },
};
  ...
  return objkts.map((i) => {
    ...
    return {
      ...
      uris: {
        ...
        hen: `https://hicetnunc.art/objkt/${i.id}`,
      },
